    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/f_project1/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "placeholder",
          section: "Projects",handler: () => {
              window.location.href = "/projects/f_project2/";
            },},{id: "projects-project-3",
          title: 'project 3',
          description: "placeholder",
          section: "Projects",handler: () => {
              window.location.href = "/projects/f_project3/";
            },},{id: "projects-image-generation-by-mot",
          title: 'Image Generation by MOT',
          description: "image generation by multi-marginal optimal transport",
          section: "Projects",handler: () => {
              window.location.href = "/projects/f_project_image/";
            },},{id: "projects-applied-optimal-transport",
          title: 'Applied Optimal Transport',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/projects/f_project_otapp/";
            },},{id: "projects-trajectory-inference-using-ot",
          title: 'Trajectory Inference Using OT',
          description: "PhD research project by Kevin Zhang",
          section: "Projects",handler: () => {
              window.location.href = "/projects/r_project_OT/";
            },},{id: "projects-trajectory-inference-using-sde",
          title: 'Trajectory Inference Using SDE',
          description: "PhD research project by Kevin Zhang",
          section: "Projects",handler: () => {
              window.location.href = "/projects/r_project_SDE/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6B%65%76%69%6E%7A%68%61%6E%67%39%36%31%30%33%30@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Diebrate", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/kevin-zhang-uoft", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=PgUJ04cAAAAJ", "_blank");
        },
      },{
      id: 'light-theme',
